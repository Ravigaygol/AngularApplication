...
export class HttpClientDemoComponent  {
 ...
 /**HTTP headers are bits of meta-data which the browser attaches to you
  * r HTTP requests when it sends them to the server.
  * We covert username:password to a base64 string and pass 
  * that to the server via a header called Authorization
  */
